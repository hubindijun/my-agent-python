  ...
  <div class="chat-page">
    ...
    >
      <div v-if="messages.length === 0" class="empty-state">
        ...
        <p class="empty-title">Agent 智能对话</p>
        <p class="empty-desc">支持工具调用的智能体，试试让它计算数学题</p>
      ...
      >
        <div class="msg-avatar" :class="msg.role === 'user' ? 'avatar--user' : 'avatar--bot'">
          ...
          <svg v-else viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" class="msg-svg" aria-hidden="true">
            <defs>
              <linearGradient id="hairGradMsgAgent" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" style="stop-color:#7c5cff"/>
                <stop offset="100%" style="stop-color:#4a3aff"/>
              </linearGradient>
              <linearGradient id="skinGradMsgAgent" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" style="stop-color:#fff5ea"/>
                <stop offset="100%" style="stop-color:#ffe4d0"/>
              </linearGradient>
              <linearGradient id="bodyGradMsgAgent" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" style="stop-color:#6366f1"/>
                <stop offset="100%" style="stop-color:#4338ca"/>
              </linearGradient>
            </defs>
            <circle cx="32" cy="16" r="12" fill="url(#skinGradMsgAgent)"/>
            <path d="M20 14 Q20 4 32 3 Q44 4 44 14 Q44 10 40 8 Q36 3 32 4 Q28 3 24 8 Q20 10 20 14 Z" fill="url(#hairGradMsgAgent)"/>
            ...
            <rect x="16" y="27" width="32" height="22" rx="10" fill="url(#bodyGradMsgAgent)"/>
...
const clearHistory = () => {
  Modal.confirm({
    ...
    onOk: async () => {
      ...
      saveToStorage()
      try {
        await fetch('/agent/chat/history', {
          method: 'DELETE',
